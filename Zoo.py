#https://www.flag.com.tw/Redirect/F1750/45
...
class Exhibit():
    def __init__(self, id_num):
        self.id_num = id_num
        self.animals = []
    def add_animal(self, *add_animals):
...
ex1.add_animal(Elephant('灰'), Zebra('黑白'))
ex2.add_animal(Snake('綠'), Parrot('灰'))
zoo.add_exhibits(ex1,ex2)

print(zoo)
print('灰色動物:', zoo.animals_by_color('灰'))
print('4 條腿動物:', zoo.animals_by_leg_num(4))
